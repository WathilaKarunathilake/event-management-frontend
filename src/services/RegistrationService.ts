import {
  ...
  registerForEvent,
} from "@/features/RegistrationsAPI";
import type {
  GetRegisteredUsers,
  RegisteredEvent,
  RegisterEvent,
...
export const handleGettingRegistrationsByUserId = async (): Promise<
  RegisteredEvent[]
> => {
  try {
...
export const handleGettingRegistrationsByEventId = async (
  id: string,
): Promise<GetRegisteredUsers[]> => {
  try {
